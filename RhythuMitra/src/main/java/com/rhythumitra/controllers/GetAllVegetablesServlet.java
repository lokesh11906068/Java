 ...
 */
@WebServlet("/getall")
public class GetAllVegetablesServlet extends HttpServlet {
     ...
     */
    public GetAllVegetablesServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Vegetable> vegetables=ivegetableService.getAllVegetables();
		if(vegetables!=null) {
		 ...
		 RequestDispatcher requestDispatcher=request.getRequestDispatcher("final.jsp");
			...
			RequestDispatcher requestDispatcher=request.getRequestDispatcher("final.jsp");
			request.setAttribute("vegetables", "No Vegetables Found");
	        requestDispatcher.forward(request, response);
		}
